...
python fddb_pr_roc.py --thresh=0.05 --model=$MODEL_PATH --standard_file=~/datasets/fddb/fddb_val_standard1.txt
python fddb_pr_roc.py --thresh=0.5 --model=$MODEL_PATH --standard_file=~/datasets/fddb/fddb_val_standard1.txt
